...
class CreateDailyMetDataTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('daily_met_data', function (Blueprint $table) {
            // primray key
            $table->id();
            ...
            $table->index(array('fecha', 'station_id'), 'daily_met_data_index');
        });
    }
    ...
    {
        Schema::dropIfExists('daily_met_data');
    }
}
