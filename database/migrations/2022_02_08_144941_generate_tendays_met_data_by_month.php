...
class GenerateTendaysMetDataByMonth extends Migration
{
    /**
     * Run the migrations.
     *
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `generate_tendays_met_data_by_month`(IN ii_year INT, IN ii_month INT)
BEGIN
