...
class CreateYearlyMetDataTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('yearly_met_data', function (Blueprint $table) {
            // primray key
            $table->id();

            // year and station id, requried fields
            $table->integer('year');
            ...
            $table->index(array('year', 'station_id'), 'yearly_met_data_index');
        });
    }
    ...
    {
        Schema::dropIfExists('yearly_met_data');
    }
}
