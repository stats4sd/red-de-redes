...
')
     ...
     */ 
        ...
        {
                        /** @var \Khill\Lavacharts\Lavacharts $instance */
                        return $instance->DataTable($args);
        }
                    /**
        ...
        {
                        /** @var \Khill\Lavacharts\Lavacharts $instance */
                        return $instance->Dashboard($label, $dataTable);
        }
                    /**
        ...
        {
                        /** @var \Khill\Lavacharts\Lavacharts $instance */
                        return $instance->ChartWrapper($chart, $elementId);
        }
                    /**
        ...
        {
                        /** @var \Khill\Lavacharts\Lavacharts $instance */
                        return $instance->exists($type, $label);
        }
                    /**
        ...
        {
                        /** @var \Khill\Lavacharts\Lavacharts $instance */
                        return $instance->fetch($type, $label);
        }
                    /**
        ...
        {
                        /** @var \Khill\Lavacharts\Lavacharts $instance */
                        return $instance->render($type, $label, $elementId, $div);
        }
                    /**
...
namespace  { 
            ...
            class SqlViews extends \Stats4SD\SqlViews\Facades\SqlViews {}
            class DataTables extends \Yajra\DataTables\Facades\DataTables {}
