...
trait ExportOperation
{
    ...
    public function export(Request $request)
    {
        ...
        // pass HTTP Request object to report generation export class
        return Excel::download(new $exporter($request), $this->crud->entity_name_plural." - ".Carbon::now()->format('Ymd_His').".xlsx");
    }
}
