...
class YearlyExport implements WithHeadings, FromQuery
{
     use Exportable;
    ...
    {
    	return Yearly::whereIn('id_station',$this->id_stations)->orderBy('fecha')->join('stations','id_station','=','stations.id');
    }
